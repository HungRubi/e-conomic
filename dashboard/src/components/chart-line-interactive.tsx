		...
		<Card className='py-4 sm:py-0'>
			<CardHeader className='flex flex-col items-stretch border-b p-0! sm:flex-row'>
				<div className='flex flex-1 flex-col justify-center gap-1 px-6 pb-3 sm:pb-0'>
					...
					<CardDescription>Theo dõi tổng lượt truy cập trong 3 tháng gần nhất</CardDescription>
				</div>
				<div className='flex'>
					{['desktop', 'mobile'].map(key => {
						...
						return (
							...
							>
								...
								<span
									className='text-lg leading-none font-semibold sm:text-2xl'
									style={{ color: `var(--color-${chart})` }}
								>
