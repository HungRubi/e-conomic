...
function parseSection(raw: unknown): HomeSection | null {
  ...
  return {
    ...
    style: raw.style !== null && raw.style !== undefined && isRecord(raw.style)
  ...
  switch (templateId) {
    ...
    case 'soul-jewelry':
      return {
        ...
        images: ['', '', ''],
        imageAlt: ['', '', ''],
        pillars: [{ title: 'Tinh thể', description: '' }, { title: 'Năng lượng', description: '' }, { title: 'Handmade', description: '' }],
        showPillars: true,
      } as unknown as Record<string, unknown>;
    case 'healing-space':
      return {
        ...
        images: ['', ''],
        imageAlt: ['', ''],
        items: [{ title: 'Dịch vụ 1', description: '' }, { title: 'Dịch vụ 2', description: '' }],
        showItems: true,
        cardEyebrow: '',
        cardDescription: '',
      } as unknown as Record<string, unknown>;
    case 'connection':
      return {
        ...
        title: '',
        description: '',
        items: [{ title: 'Mục 1', description: '' }, { title: 'Mục 2', description: '' }, { title: 'Mục 3', description: '' }],
      } as unknown as Record<string, unknown>;
    case 'split-blocks':
      return {
        eyebrow: '',
...
export function defaultHomePageContent(): HomeContentV1 {
  return {
    ...
    sections: [
      newHomeSection('hero'),
      newHomeSection('two-column'),
      newHomeSection('video'),
    ],
  };
}
