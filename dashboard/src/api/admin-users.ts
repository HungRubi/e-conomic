...
export function fetchUserById(_id: string) { return getUser(_id); }
export function createCustomer(_data: any) { return createUser(_data); }
export function createInternalUser(_data: any) { return createUser(_data); }
export function deleteCustomersBulk(_ids: string[]) { return Promise.resolve({ deleted: _ids.length }); }
export function fetchCustomers(_params?: any) { return listUsers(_params); }
export function fetchInternalUsers(_params?: any) { return listUsers(_params); }
