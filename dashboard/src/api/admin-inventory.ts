...
export type InventoryDetailResponse = { product: AdminProductRow | null; variants: AdminProductVariant[]; transactions: InventoryTransaction[] };
...
export function batchReceiveVariants(data?: any): Promise<any> { return Promise.resolve({ received: 0, ...data }); }
export function previewCustomProductStock(_data?: any): Promise<CustomProductPreviewResponse> { return Promise.resolve(preview); }
