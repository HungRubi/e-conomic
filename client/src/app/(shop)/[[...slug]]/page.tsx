...
function HomeContent() {
	...
	return (
		<div>
			{/* ─── HERO ─── */}
			<section
				className='mt-4 group relative overflow-hidden rounded-xl bg-bg'
				style={{ height: 'clamp(180px, 25vh, 250px)' }}
			>
				...
				<button
					onClick={prevSlide}
					className='absolute left-3 top-1/2 -translate-y-1/2 z-20 w-8 h-8 md:w-10 md:h-10 rounded-full bg-black/40 backdrop-blur-sm text-white flex items-center justify-center hover:bg-black/60 transition-all opacity-0 group-hover:opacity-100'
					aria-label='Previous'
				>
				...
				<button
					onClick={nextSlide}
					className='absolute right-3 top-1/2 -translate-y-1/2 z-20 w-8 h-8 md:w-10 md:h-10 rounded-full bg-black/40 backdrop-blur-sm text-white flex items-center justify-center hover:bg-black/60 transition-all opacity-0 group-hover:opacity-100'
					aria-label='Next'
				>
