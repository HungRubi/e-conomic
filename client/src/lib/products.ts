...
export const products: Product[] = [
	{
		...
		description:
			'Áo thun chất liệu cotton 100% cao cấp, mềm mại, thoáng mát. Thiết kế đơn giản nhưng tinh tế, phù hợp cho cả nam và nữ. Form regular fit, không co rút sau khi giặt.',
		price: 299000,
	...
	},
	{
		...
		description:
			'Tai nghe không dây chống ồn chủ động ANC, chất âm Hi-Res, thời lượng pin 30 giờ. Sạc nhanh USB-C, chống nước IPX5.',
		price: 1590000,
	...
	},
	{
		...
		description:
			'Đèn bàn LED hiện đại với thiết kế tối giản. 3 chế độ sáng, chống mỏi mắt, có cổng sạc USB. Phù hợp cho không gian làm việc và học tập.',
		price: 499000,
	...
	},
	{
		...
		description:
			'Serum vitamin C 15% kết hợp EGF và Hyaluronic Acid. Giúp làm sáng da, mờ thâm nám, cấp ẩm sâu. An toàn cho mọi loại da.',
		price: 389000,
	...
	},
	{
		...
		description:
			'Giày chạy bộ siêu nhẹ với công nghệ đệm Boost, thoáng khí, độ bám cao. Thích hợp cho chạy đường dài và tập luyện hàng ngày.',
		price: 1890000,
	...
	},
	{
		...
		description:
			'Cuốn sách toàn diện về TypeScript từ cơ bản đến nâng cao. Bao gồm: types, generics, decorators, design patterns, và dự án thực tế.',
		price: 249000,
		images: ['https://images.unsplash.com/photo-1532012197267-da84d127e765?w=600&h=600&fit=crop'],
		categoryId: 'cat-6',
		variants: [{ id: 'v-15', productId: 'prod-6', sku: 'TS-BOOK', stock: 200, price: 249000 }],
		tags: ['mới'],
		rating: 4.4,
		reviewCount: 56,
	...
	},
	{
		...
		description:
			'Áo khoác denim cổ điển, chất liệu bền đẹp, form dáng chuẩn. Phối hợp dễ dàng với nhiều trang phục.',
		price: 699000,
	...
	},
	{
		...
		description:
			'Máy ảnh chụp liền Polaroid thế hệ mới. Tính năng tự động lấy nét, chế độ chân dung, màu sắc rực rỡ.',
		price: 1290000,
...
export function getFeaturedProducts(): Promise<Product[]> {
	return new Promise(resolve => setTimeout(() => resolve(products.filter(p => p.tags.includes('bán chạy'))), 300));
}
...
export function getRelatedProducts(productId: string): Promise<Product[]> {
	...
	return new Promise(resolve =>
		setTimeout(() => resolve(products.filter(p => p.id !== productId && p.categoryId === product.categoryId)), 300)
	);
}
