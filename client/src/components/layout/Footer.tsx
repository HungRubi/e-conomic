			...
			<div className='max-w-[90rem] mx-auto px-3 md:px-4 py-5'>
				...
				<div className='grid grid-cols-2 md:grid-cols-4 gap-8'>
					...
					{footerSections.map(section => (
						<div key={section.title}>
							<h3 className='text-sm font-semibold text-text mb-3'>{section.title}</h3>
				...
				<div className='mt-10 pt-8 border-t border-border'>
					<div className='max-w-md'>
						<h3 className='text-sm font-semibold text-text mb-2'>Đăng ký nhận tin</h3>
						<p className='text-sm text-text2 mb-3'>Nhận ưu đãi & sản phẩm mới qua email.</p>
